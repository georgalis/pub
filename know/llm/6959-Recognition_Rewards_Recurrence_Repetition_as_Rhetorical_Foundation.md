...
The boundary sharpens around gravity of subject. Alliteration in elegy risks trivializing grief; in formal argument, it may suggest the advocate values cleverness over substance. The device should be withheld when listeners might perceive manipulation, when subject matter demands austere treatment, or when frequency would transform emphasis into mannerism.

---

# Repetition Within the Sentence: Epizeuxis and Its Cognates
...
Each figure accomplishes distinct rhetorical work. Epizeuxis intensifies through temporal extension; anaphora builds parallel force; anadiplosis creates progressive chain; polyptoton introduces grammatical counterpoint. The sophisticated rhetorician selects among these instruments according to the specific emphasis required.

---

# Paragraph-Scale Repetition: The Consolidation Phase
...
# Concept Repetition Across Documents: Dimensional Rotation
